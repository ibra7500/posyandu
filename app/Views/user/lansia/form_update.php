            ...
            <form action="<?= base_url('Lansia/edit_data/'.$lansia['nik_lansia']); ?>" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-4 my-3">
                        ...
                        <input type="text" value="<?=$lansia['nik_lansia']?>" class="form-control " name="nik_lansia" readonly>
                    </div>

                    <div class="form-group col-4 my-3">
                        <label for="" class="font-weight-bold">Nama</label>
                        <input type="text" value="<?=$lansia['nama']?>" class="form-control " name="nama_lansia">
                    </div>
                    ...
                    <div class="form-group col-4 my-3">
                        ...
                        <input name="tgl_lahir" type="date" value="<?=$lansia['tgl_lahir']?>" class="form-control ">
                    </div>
                    
                    <div class="form-group col-4 my-3">
                        <label for="" class="font-weight-bold">No HP</label>
                        <input type="text" value="<?=$lansia['no_hp']?>" class="form-control " name="no_hp">
                    </div>

                    <div class="form-group col-4 my-3">
                        <label for="" class="font-weight-bold">Status Kesehatan</label>
                        <input type="text" value="<?=$lansia['status_kesehatan']?>" class="form-control " name="status_kesehatan">
                    </div>
                 </div>

                 <div class="form-group-inline my-4">
                        <label for="" class="font-weight-bold">Alamat</label>
                        <textarea class="form-control" name="alamat" rows="3"><?=$lansia['alamat']?></textarea>
                </div>
