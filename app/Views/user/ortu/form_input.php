    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <ol class="breadcrumb mb-4">
                ...
                <li class="breadcrumb-item"><a href="<?= base_url('Orang Tua'); ?>">Data Orang Tua</a></li>
        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-4 my-3">
                    ...
                    <input type="text" value="" class="form-control " name="nama_ayah" placeholder="Masukkan Nama Ayah">
                </div>
                ...
                <div class="form-group col-4 my-3">
                    ...
                    <input type="text" value="" class="form-control " name="nama_ibu" placeholder="Masukkan Nama Ibu">
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">No HP Ayah</label>
                    <input type="text" value="" class="form-control " name="no_hp_ayah" placeholder="Masukkan No HP Ayah">
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">No HP Ibu</label>
                    <input type="text" value="" class="form-control " name="no_hp_ibu" placeholder="Masukkan No HP Ibu">
                </div>
