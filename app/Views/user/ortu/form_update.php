            ...
            <form action="<?= base_url('Orang_Tua/edit_data/'.$ortu['id_ortu']); ?>" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-4 my-3">
                        ...
                        <input type="hidden" value="<?=$ortu['id_ortu']?>" class="form-control " name="id_ortu" readonly>
                        <input type="text" value="<?=$ortu['nik_ayah']?>" class="form-control " name="nik_ayah" readonly>
                    </div>

                    <div class="form-group col-4 my-3">
                        <label for="" class="font-weight-bold">Nama Ayah</label>
                        <input type="text" value="<?=$ortu['nama_ayah']?>" class="form-control " name="nama_ayah">
                    </div>

                    <div class="form-group col-4 my-3">
                        <label for="" class="font-weight-bold">NIK Ibu</label>
                        <input type="text" value="<?=$ortu['nik_ibu']?>" class="form-control " name="nik_ibu" readonly>
                    </div>

                    <div class="form-group col-4 my-3">
                        <label for="" class="font-weight-bold">Nama Ibu</label>
                        <input type="text" value="<?=$ortu['nama_ibu']?>" class="form-control " name="nama_ibu">
                    </div>
                    
                    <div class="form-group col-4 my-3">
                        <label for="" class="font-weight-bold">No HP Ayah</label>
                        <input type="text" value="<?=$ortu['no_hp_ayah']?>" class="form-control " name="no_hp_ayah">
                    </div>

                    <div class="form-group col-4 my-3">
                        <label for="" class="font-weight-bold">No HP Ibu</label>
                        <input type="text" value="<?=$ortu['no_hp_ibu']?>" class="form-control " name="no_hp_ibu">
                    </div>
