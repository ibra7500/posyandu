        ...
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col-4 my-3">
                    ...
                    <input type="text" value="" class="form-control " name="nik_ibu_hamil" placeholder="Masukkan NIK Ibu" required>
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">Nama</label>
                    <input type="text" value="" class="form-control " name="nama_ibu_hamil" placeholder="Masukkan Nama Ibu" required>
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">Umur</label>
                    <input type="number" value="" class="form-control " name="umur" placeholder="Masukkan Umur Ibu" required>
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">Hamil Keberapa?</label>
                    <input type="text" value="" class="form-control " name="hamil_keberapa" required>
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">Anak Keberapa?</label>
                    <input type="text" value="" class="form-control " name="anak_keberapa" required>
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">Hari Pertama Haid Terakhir (HPHT)</label>
                    <input type="date" value="" class="form-control " name="hpht" id="tgl_hpht" required>
                </div>
               
                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">Skor Rochjati </label>
                    <input type="text" value="" class="form-control " name="skor_rochjati" required>
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">Nama Suami</label>
                    <input type="text" value="" class="form-control " name="nama_suami" placeholder="Masukkan Nama Suami" required>
                </div>
