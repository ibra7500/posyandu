        ...
        <div class="card-body">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-4 my-3">
                    ...
                    <input type="text" value="" class="form-control " name="no_hp" required>
                </div>
                ...
                <div class="form-group col-4 my-3">
                    ...
                    <input name="tgl_vaksin_pertama" type="date" value="" class="form-control" required>
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">Tempat Vaksin Pertama</label>
                    <input name="tempat_vaksin_pertama" type="text" value="" class="form-control" required>
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">Jenis Vaksin Pertama</label>
                    <input name="jenis_vaksin_pertama" type="text" value="" class="form-control" required>
                </div>
