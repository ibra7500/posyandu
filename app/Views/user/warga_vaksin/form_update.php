        ...
        <div class="card-body">
            ...
            <div class="form-row">
                <div class="form-group col-4 my-3">
                    ...
                    <input type="text" value="<?= $vaksin['nik']; ?>" class="form-control " name="nik" readonly>
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">Nama</label>
                    <input type="text" value="<?= $vaksin['nama']; ?>" class="form-control " name="nama">
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">No HP</label>
                    <input type="text" value="<?= $vaksin['no_hp']; ?>" class="form-control " name="no_hp">
                </div>
                ...
                <div class="form-group col-4 my-3">
                    ...
                    <input name="tgl_vaksin_pertama" type="date" value="<?= $vaksin['tgl_vaksin_pertama']; ?>" class="form-control ">
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">Tempat Vaksin Pertama</label>
                    <input name="tempat_vaksin_pertama" type="text" value="<?= $vaksin['tempat_vaksin_pertama']; ?>" class="form-control ">
                </div>

                <div class="form-group col-4 my-3">
                    <label for="" class="font-weight-bold">Jenis Vaksin Pertama</label>
                    <input name="jenis_vaksin_pertama" type="text" value="<?= $vaksin['jenis_vaksin_pertama']; ?>" class="form-control ">
                </div>
            ...
            <div class="form-group-inline my-4">
                    ...
                    <input type="text" value="<?= $vaksin['alamat']; ?>" class="form-control " name="alamat">
            </div>
